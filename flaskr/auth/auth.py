...
def sign_up():
    if request.method == 'POST':
        ...
        elif not validate_name(user_data['user_name']):
        ...
        elif not validate_number(user_data['contact_number']) and user_data['contact_number'] is not None:
        ...
        elif user_data['password'] is not None:
